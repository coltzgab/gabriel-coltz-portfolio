    ...
    <section id="ai-audit" className="py-24 bg-organic-gray relative">
      ...
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-organic-black border border-organic-white/10 p-8 rounded-none relative overflow-hidden">
            {/* Background Glow */}
            ...
            {status === AnalysisStatus.IDLE || status === AnalysisStatus.LOADING || status === AnalysisStatus.ERROR ? (
              <div className="relative z-10">
                ...
                <textarea
                  ...
                  className="w-full h-32 bg-organic-white/5 border border-organic-white/10 p-4 text-organic-white focus:outline-none focus:border-organic-cyan transition-colors resize-none mb-6"
                />
              ...
              <div className="relative z-10 animate-fade-in">
                 ...
                 {result && (
                   <div className="grid gap-6 md:grid-cols-2">
                      <div className="col-span-2 bg-gradient-to-r from-organic-cyan/10 to-transparent p-6 border-l-4 border-organic-cyan">
                      ...
                      <div className="bg-organic-white/5 p-6">
                      ...
                      <div className="bg-organic-white/5 p-6">
                        ...
                        <p className="text-organic-white/90 italic border-l border-organic-white/20 pl-4 py-2">
                          "{result.vibe}"
                        </p>
                      </div>
                   </div>
